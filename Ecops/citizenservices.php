...
?>
      ...
      <div class="container">
        <div class="row justify-content-center text-center mb-5">
          <div class="col-md-6" data-aos="fade" >
            <h2 class="text-black"><strong>Citizen Services</strong> </h2>
          </div>
        </div>
          ...
          <div class="col-md-6 col-lg-4 mb-5 mb-lg-4" data-aos="fade" data-aos-delay="100">
            ...
            <div class="unit-3 h-100 bg-white">
              ...
              <div class="d-flex align-items-center mb-3 unit-3-heading">
                ...
                <a href="firlodge.php"><h2 class="h5">FIR lodge</h2></a>
              </div>
              <div class="unit-3-body">
                <p>write a FIR here</p>
              </div>
            </div>
          ...
          <div class="col-md-6 col-lg-4 mb-5 mb-lg-4" data-aos="fade" data-aos-delay="200">
            ...
            <div class="unit-3 h-100 bg-white">
              ...
              <div class="d-flex align-items-center mb-3 unit-3-heading">
                ...
                <a href="viewfir.php"><h2 class="h5">View FIR</h2></a>
              </div>
              <div class="unit-3-body">
                <p>View FIRs that written by citizens.</p>
              </div>
            </div>
          ...
          <div class="col-md-6 col-lg-4 mb-5 mb-lg-4" data-aos="fade" data-aos-delay="300">
            ...
            <div class="unit-3 h-100 bg-white">
              ...
              <div class="d-flex align-items-center mb-3 unit-3-heading">
                ...
                <a href="vehicle.php"><h2 class="h5">Vehicle Missing</h2></a>
              </div>
              <div class="unit-3-body">
                <p>Write a vehicle missing complaints.</p>
              </div>
            </div>
          ...
          <div class="col-md-6 col-lg-4 mb-5 mb-lg-4" data-aos="fade" data-aos-delay="400">
            ...
            <div class="unit-3 h-100 bg-white">
              ...
              <div class="d-flex align-items-center mb-3 unit-3-heading">
                ...
                <a href="child-missing.php"><h2 class="h5">Child Missing</h2></a>
              </div>
              <div class="unit-3-body">
                <p>Write a Child Missing Complaints.</p>
              </div>
            </div>
          ...
          <div class="col-md-6 col-lg-4 mb-5 mb-lg-4" data-aos="fade" data-aos-delay="500">
            ...
            <div class="unit-3 h-100 bg-white">
              ...
              <div class="d-flex align-items-center mb-3 unit-3-heading">
                ...
                <a href="safetytips.php"><h2 class="h5">Safety Tips</h2></a>
              </div>
              <div class="unit-3-body">
                <p>Safety tips for citizens safety.</p>
              </div>
            </div>
  ...
  <div class="unit-3 h-100 bg-white">
    ...
    <div class="d-flex align-items-center mb-3 unit-3-heading">
      ...
      <a href="viewvehicle.php"><h2 class="h5">View Vehicle Missing</h2></a>
    </div>
    <div class="unit-3-body">
      <p>You can see here vehicle missing complaints</p>
    </div>
  </div>
</div>
<div class="col-md-6 col-lg-4 mb-5 mb-lg-4" data-aos="fade" data-aos-delay="500">
  ...
  <div class="unit-3 h-100 bg-white">
    ...
    <div class="d-flex align-items-center mb-3 unit-3-heading">
      ...
      <a href="viewchildmissing.php"><h2 class="h5">View Child Missing</h2></a>
    </div>
    <div class="unit-3-body">
      <p>You can see here child missing complaints.</p>
    </div>
  </div>
</div>
          <div class="col-md-6 col-lg-4 mb-5 mb-lg-4" data-aos="fade" data-aos-delay="600">
            ...
            <div class="unit-3 h-100 bg-white">
              ...
              <div class="d-flex align-items-center mb-3 unit-3-heading">
                ...
                <a href="criminal.php"><h2 class="h5">Criminals</h2></a>
              </div>
              <div class="unit-3-body">
                <p>You can see here criminal Records</p>
              </div>
            </div>
